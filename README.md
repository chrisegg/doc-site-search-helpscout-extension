...
This extension for Chrome and Firefox browsers adds support for searching the `docs.gravityforms.com`, `docs.gravityflow.io`, `docs.gravitysmtp.com`, `gravitywiz.com`, and `gravitykit.com` websites from within Help Scout. Just type Command + J on Mac or Ctrl + J on Windows.
